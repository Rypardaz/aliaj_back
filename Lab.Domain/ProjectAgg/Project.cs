...
public class Project : AuditableAggregateRootBase<long>
{
    ...
    public List<ProjectReplacementWireType>? ReplacementWireTypes { get; private set; }
    ...
    public Project(Guid creator, string code, string name, long taskMasterId, long projectTypeId,
        long salonId, string deliveryDate, int isActive, string? description,
    ...
    public void SetReplacements(List<ProjectReplacementWireType>? replacementWireTypes)
    {
        ReplacementWireTypes = replacementWireTypes;
    }
}